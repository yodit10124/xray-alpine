...
download_or_upgrade() {
    ...
    if [[ "$OS" == "Darwin" && "$ARCH" == "arm64" ]]; then
        DOWNLOAD_URL="https://git.808074.xyt/https://github.com/semicons/java_oci_manage/releases/latest/download/gz_client_bot_mac_aarch.tar.gz"
    elif [[ "$OS" == "Darwin" ]]; then
        print_red "✗ macOS 仅支持 Apple Silicon (arm64)，当前架构: $ARCH"
        exit 1
    elif [[ "$ARCH" == "aarch64" ]]; then
        DOWNLOAD_URL="https://git.808074.xyt/https://github.com/semicons/java_oci_manage/releases/latest/download/gz_client_bot_aarch.tar.gz"
        ...
        if [ "$supports_advanced" = true ]; then
            DOWNLOAD_URL="https://git.808074.xyt/https://github.com/semicons/java_oci_manage/releases/latest/download/gz_client_bot_x86.tar.gz"
        else
            DOWNLOAD_URL="https://git.808074.xyt/https://github.com/semicons/java_oci_manage/releases/latest/download/gz_client_bot_x86_compatible.tar.gz"
        fi
    else
